...
import com.parift.rideshare.adapter.OfferListAdapter;
...
public class OfferListFragment extends BaseFragment {
    public static final String TAG = OfferListFragment.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = view.findViewById(R.id.offer_list);
    ...
    private void loadInitialData() {
        ...
        String URL = GET_OFFERS_URL.replace(APIUrl.PAGE_KEY, Integer.toString(0));
    ...
    private void setAdapter() {
        ...
        mAdapter = new OfferListAdapter(mOffers, this);
    ...
    public void loadNextDataFromApi(final int offset) {
        ...
        String URL = GET_OFFERS_URL.replace(APIUrl.PAGE_KEY, Integer.toString(offset));
        ...
        RESTClient.get(URL, null, new RSJsonHttpResponseHandler(mCommonUtil){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                if (isAdded()) {
                    ...
                    mAdapter.notifyItemRangeInserted(mAdapter.getItemCount(), mOffers.size() - 1);
                }
            }
        });
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onOfferListFragmentInteraction(String data);
    }
}
