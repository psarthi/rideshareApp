...
public class APIUrl {
    ...
    public static final String POST_URL = "http://10.0.0.5:8080/RSRideSystem/api/domain/ridesystem/testdate";
    public static final String GET_URL = "http://10.0.0.5:8080/RSRideSystem/api/domain/ridesystem/test";
}
