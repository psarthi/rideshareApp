...
public class APIUrl {
    ...
    public static final String BASE_URL_RIDE_SYSTEM = "http://172.20.10.2:8080/RSRideSystem/api";
    public static final String BASE_URL_USER_SYSTEM = "http://172.20.10.2:8080/RSUserSystem/api";
    ...
    public static final String DROP_PASSENGER = BASE_URL_RIDE_SYSTEM + "/rides/{rideId}/drop/{rideRequestId}?ridemode={rideMode}";
